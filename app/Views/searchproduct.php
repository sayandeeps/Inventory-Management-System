...
<div class="justify-center w-full px-4 py-4 mx-auto ">
    ...
    <form action="<?= base_url('insearchproduct') ?>" method="post">
...
<div class="bg-white rounded-md  :bg-gray-800">
                <div class="p-4 mb-4">
                    <div class="flex items-center justify-between mb-3">
                        <select name="status" id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block  p-2.5">
                            <option value="" disabled hidden>Select status</option>
                            <option value="in_stock" <?= ($product['status'] == 1) ? 'selected' : '' ?>>In Stock</option>
                            <option value="out_of_stock" <?= ($product['status'] == 0) ? 'selected' : '' ?>>Out Of Stock</option>
                        </select>
                    ...
                    <div class="relative flex items-center max-w-[8rem]">
                        <button type="button" class="bg-gray-100 outline-none :bg-gray-700 :hover:bg-gray-600 :border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-s-lg p-3 h-11 focus:ring-gray-100 :focus:ring-gray-700 focus:ring-2 focus:outline-none decrement-button">
                        ...
                        <input type="text" name="quantity-input" aria-describedby="helper-text-explanation" class="bg-gray-50 border-x-0 border-gray-300 h-11 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500" value="<?= $product['quantity'] ?>" required="">
                        <button type="button" class="bg-gray-100 :bg-gray-700 :hover:bg-gray-600 :border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-e-lg p-3 h-11 focus:ring-gray-100 :focus:ring-gray-700 focus:ring-2 focus:outline-none increment-button">
                    ...
                    <h2 class="mb-1 text-m   text-gray-400"><?= $product['description'] ?></h2>
                    <div class=" flex items-center justify-between mb-2">
                        <h2 class="text-sm font-medium mb-2 :text-gray-400">Category : <?= $product['category'] ?></h2>
                         
                        <div>
                            <label for="price" class="block mb-2 text-sm font-medium text-gray-900 :text-white">Price</label>
                            <input type="text" id="price" name="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="<?= $product['price'] ?>" required>
                        </div>

                    </div>
                    <p class="text-sm font-medium  :text-gray-400">Upadated At : <?= $product['updated_at'] ?></p>
    ...
    document.querySelectorAll('.increment-button').forEach(button => {
        button.addEventListener('click', function() {
            ...
            inputElement.value = parseInt(inputElement.value) + 1 || 0;
        });
    });
