        ...
        <div class="body-content" x-data="{ open: true }">
            <div class="relative lg:block navbar-menu">
                <nav x-bind:class="! open ? 'w-0' : 'w-[280px]'"
                    ...
                    id="sidenav">
                    <div class="flex items-center w-full px-4 pt-4 pb-4 border-b border-gray-200  :border-gray-700">
                        <a href="#">
                            <div class="flex items-center ml-2">
                                <h2 class="ml-3 text-lg font-bold text-gray-700  :text-gray-400 whitespace-nowrap">
                                    Your Logo </h2>
                            </div>
                        </a>
                    </div>
                    <div>
                        ...
                        <div class="flex justify-center ">
                            <div>
                                <h2 class="text-xl font-semibold  :text-gray-300 ">John Doe</h2>
                    ...
                    <div class="pb-6 mt-4 overflow-x-hidden overflow-y-auto ">
                        <ul class="mb-8 text-sm">
                            <li>
                                <a href="#"
                                    class="flex items-center px-8 py-4 text-gray-100 bg-blue-600  :text-gray-200  :bg-blue-500  :hover:bg-gray-700 hover:bg-blue-500">
                            ...
                            <li x-data="{ open: false }">
                                ...
                                <div class="pl-3 ml-3 transition border-gray-500 dropdown-section nested-menu"
                                    ...
                                    <ul class="text-sm">
                                        <li>
                                            <a href="#"
                                                class="flex items-center py-3 pl-8 pr-4 text-gray-700 rounded  :text-gray-400  :hover:bg-gray-700 hover:bg-gray-100 ">
                                                <span class="text-gray-700  :text-gray-400 ">Profile</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="flex items-center py-3 pl-8 pr-4 text-gray-700 rounded  :text-gray-400  :hover:bg-gray-700 hover:bg-gray-100 ">
                                                <span class="text-gray-700  :text-gray-400 ">Leave</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="flex items-center py-3 pl-8 pr-4 text-gray-700 rounded  :text-gray-400  :hover:bg-gray-700 hover:bg-gray-100 ">
                                                <span class="text-gray-700  :text-gray-400 ">Assets</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li>
                                <a href="#"
                                    ...
                                    <span class="inline-block mr-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor"
                                            class="w-5 h-5  :group-hover:text-gray-300 bi bi-basket"
                                            viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <span> Products </span>
                                    <span
                                        class="flex items-center justify-center w-6 h-6 px-2 ml-auto text-xs text-indigo-600 bg-indigo-100 rounded  :group-hover:bg-gray-900  :bg-gray-700  :text-gray-100">5</span>
                                </a>
                            </li>
                            <li x-data="{ open: false }">
                                <a href="#" @click="open = ! open"
                                ...
                                <div class="pl-3 ml-3 transition border-gray-500 dropdown-section nested-menu"
                                    ...
                                    <ul class="text-sm ">
                                        <li>
                                            <a href="#"
                                                class="flex items-center py-3 pl-8 pr-4 text-gray-700 rounded  :text-gray-400  :hover:bg-gray-700 hover:bg-gray-100 ">
                                                <span class="text-gray-700  :text-gray-400 ">Inbox</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="flex items-center py-3 pl-8 pr-4 text-gray-700 rounded  :text-gray-400  :hover:bg-gray-700 hover:bg-gray-100 ">
                                                <span class="text-gray-700  :text-gray-400 ">Read Email</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="flex items-center py-3 pl-8 pr-4 text-gray-700 rounded  :text-gray-400  :hover:bg-gray-700 hover:bg-gray-100 ">
                                                <span class="text-gray-700  :text-gray-400 ">Compose Email</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
            ...
            <div class="mx-auto transition-all content-wrapper" id="dash"
                ...
                <section
                    class="sticky top-0 z-40 px-3 py-3 bg-white shadow  :text-gray-100  :bg-gray-900 lg:px-5">
                    <nav class="relative">
                        <div class="flex items-center justify-between">
                            <div>
                                <button x-on:click="open = ! open"
                                    class="px-2 py-3 text-blue-500 bg-blue-100 rounded  :text-gray-400  :bg-gray-800">
                            ...
                            <div class="flex items-center">
                                <div class="justify-center hidden mr-4 md:flex">
                                    <div class=" xl:w-96">
                                        <div class="relative flex flex-wrap items-center w-full ">
                                            <input type="search"
                                                class="form-control relative flex-auto min-w-0 block w-72 px-3 py-1.5 text-base font-normal text-gray-700 bg-white   :text-gray-100  border border-solid border-gray-300  :border-gray-800 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white  :bg-gray-800  focus:border-b  :border-gray-700lue-600 focus:outline-none"
                                                placeholder="Search">
                                            <button
                                                class="btn i px-6 py-2.5 bg-blue-600  :bg-blue-300  :hover:bg-blue-400   :text-gray-900 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center"
                                ...
                                <div class="relative text-left lg:inline-block" x-data="{ open: false }">
                                    <div class="lg:block" @click="open = ! open">
                                        <button class="flex items-center">
                                            <div class="hidden mr-3 text-right md:block">
                                                <p class="text-sm font-bold text-black  :text-gray-400"> John Doe
                                                </p>
                                            </div>
                                            <div class="mr-2">
                                    ...
                                    <div x-show="open" id="dropdown_profile"
                                        class="absolute right-0 w-48 mt-3 origin-top-right bg-white rounded shadow  :bg-gray-800  :text-gray-100  :bg-gray-700"
                                        style="display: none;">
                                        <div class="py-1">
                                            <a href="#"
                                                class="flex px-4 py-2 text-sm text-gray-700  :text-gray-400  :hover:bg-gray-800 hover:bg-gray-100">
                                            ...
                                            <a href="#"
                                                class="flex px-4 py-2 text-sm text-gray-700  :hover:bg-gray-800  :text-gray-400 hover:bg-gray-100">
                                                <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" width="18"
                                                    height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <section class="px-4 py-6">
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        <div class="p-4 bg-white rounded-md shadow md:p-6  :bg-gray-900 ">
                            <div class="flex flex-wrap justify-between mb-6">
                                <h2
                                    class="py-1 text-xl font-semibold capitalize border-b border-blue-500  :text-gray-400">
                                    Recent Orders
                                </h2>
                            ...
                            <div>
                                <div class="flex justify-between mb-4">
                                    <div class="flex gap-2">
                                        ...
                                        <div class="">
                                            <h2 class="my-1 text-lg font-medium  :text-gray-400">
                        ...
                        <div class="p-4 bg-white rounded-md shadow md:p-6  :bg-gray-900">
                            ...
                            <div>
                                <div class="flex items-center justify-between px-4">
                                    <span tabindex="0"
                                        class="text-base font-bold text-gray-800 focus:outline-none  :text-gray-100">January
                                        2022</span>
                                    <div class="flex items-center">
                                        <button aria-label="calendar backward"
                                            class="text-gray-800 focus:text-gray-400 hover:text-gray-400  :text-gray-100">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <button aria-label="calendar forward"
                                            class="ml-3 text-gray-800 focus:text-gray-400 hover:text-gray-400  :text-gray-100">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            ...
                                            <tr>
                                                <th>
                                                    <div class="flex justify-center w-full">
                                                        <p
                                                            class="text-base font-medium text-center text-gray-800  :text-gray-100">
                                                            Su</p>
                                                    </div>
                                                </th>
                                                <th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="pt-6">
                                                    <div class="flex justify-center w-full px-2 py-2 cursor-pointer">
                                                        <p
                                                            class="text-base font-medium text-gray-500  :text-gray-400">
                                                            1
                                                        </p>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="pt-6">
                                                    <div class="flex justify-center w-full px-2 py-2 cursor-pointer">
                                                        <p class="text-base text-gray-500  :text-gray-400">3</p>
                                                    </div>
                                                </td>
                                                <td class="pt-6">
                                                    <div class="flex justify-center w-full px-2 py-2 cursor-pointer">
                                                        <p class="text-base text-gray-500  :text-gray-400">4</p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex justify-center w-full px-2 py-2 cursor-pointer">
                                                        <p class="text-base text-gray-500  :text-gray-400">10</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="flex justify-center w-full px-2 py-2 cursor-pointer">
                                                        <p class="text-base text-gray-500  :text-gray-400">11</p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex justify-center w-full px-2 py-2 cursor-pointer">
                                                        <p class="text-base text-gray-500  :text-gray-400">17</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="flex justify-center w-full px-2 py-2 cursor-pointer">
                                                        <p class="text-base text-gray-500  :text-gray-400">18</p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex justify-center w-full px-2 py-2 cursor-pointer">
                                                        <p class="text-base text-gray-500  :text-gray-400">24</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="flex justify-center w-full px-2 py-2 cursor-pointer">
                                                        <p class="text-base text-gray-500  :text-gray-400">25</p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                ...
                <section class="px-4 pt-6">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
                        <div class="p-4 bg-white rounded-lg shadow hover:shadow-xl  :bg-gray-900">
                            <div class="flex flex-row items-center">
                                <div class="flex-1 text-left md:text-left">
                                    <h2 class="mb-2 text-lg font-bold text-gray-600 uppercase  :text-gray-400">
                                        Total orders</h2>
                                    <p class="mb-2 text-lg font-medium text-gray-600  :text-gray-400">110 </p>
                                    <p class="text-sm font-medium text-gray-400  :text-gray-400">Lorem ipsum dor amet
                                    </p>
                                </div>
                                <div class="flex-shrink">
                                    <a href="#" class="flex items-center px-8 py-4 text-gray-400  :text-gray-400 ">
                                        <span class="inline-block mr-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor"
                                                class="w-10 h-10  :group-hover:text-gray-300 bi bi-basket"
                                                viewBox="0 0 16 16">
                                                <path
                                                    d="M5.757 1.071a.5.5 0 0 1 .172.686L3.383 6h9.234L10.07 1.757a.5.5 0 1 1 .858-.514L13.783 6H15a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1v4.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 13.5V9a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h1.217L5.07 1.243a.5.5 0 0 1 .686-.172zM2 9v4.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V9H2zM1 7v1h14V7H1zm3 3a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 4 10zm2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 6 10zm2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 8 10zm2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3a.5.5 0 0 1 .5-.5zm2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3a.5.5 0 0 1 .5-.5z">
                                                </path>
                        ...
                        <div class="p-4 bg-white rounded-lg shadow hover:shadow-xl  :bg-gray-900">
                            <div class="flex flex-row items-center">
                                <div class="flex-1 text-left md:text-left">
                                    <h2 class="mb-2 text-lg font-bold text-gray-600 uppercase  :text-gray-400">
                                        Total Revenue</h2>
                                    <p class="mb-2 text-lg font-medium text-gray-600  :text-gray-400">569 </p>
                                    <p class="text-sm font-medium text-gray-400  :text-gray-400">Lorem ipsum dor amet
                                    </p>
                                </div>
                                <div class="flex-shrink">
                                    <a href="#" class="flex items-center px-8 py-4 text-gray-400  :text-gray-400 ">
                                        <span class="inline-block mr-3  :group-hover:text-gray-300">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <div class="p-4 bg-white rounded-lg shadow hover:shadow-xl  :bg-gray-900">
                            <div class="flex flex-row items-center">
                                <div class="flex-1 text-left md:text-left">
                                    <h2 class="mb-2 text-lg font-bold text-gray-600 uppercase  :text-gray-400">
                                        Total Payment</h2>
                                    <p class="mb-2 text-lg font-medium text-gray-600  :text-gray-400">4567 </p>
                                    <p class="text-sm font-medium text-gray-400  :text-gray-400">Lorem ipsum dor amet
                                    </p>
                                </div>
                                <div class="flex-shrink">
                        ...
                        <div class="p-4 bg-white rounded-lg shadow hover:shadow-xl  :bg-gray-900">
                            <div class="flex flex-row items-center">
                                <div class="flex-1 text-left md:text-left">
                                    <h2 class="mb-2 text-lg font-bold text-gray-600 uppercase  :text-gray-400">
                                        Total Customers</h2>
                                    <p class="mb-2 text-lg font-medium text-gray-600  :text-gray-400">2310 </p>
                                    <p class="text-sm font-medium text-gray-400  :text-gray-400">Lorem ipsum dor amet
                                    </p>
                                </div>
                                <div class="flex-shrink">
                ...
                <section class="px-4 py-6">
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 ">
                        <div class="p-4 bg-white rounded-md shadow md:p-6  :bg-gray-900 ">
                            <h2 class="pb-4 text-xl font-bold border-b  :border-gray-700  :text-gray-400">Task
                                overview</h2>
                            <div class="px-4 py-3 text-xs font-medium">
                                <div class="flex px-4 mb-3 text-gray-500  :text-gray-400">
                                    <h2 class="mr-auto">Task Name</h2>
                                    <h2>Action</h2>
                                </div>
                                <div class="flex justify-between p-4 mb-4 bg-gray-100 rounded  :bg-gray-800">
                                    <div class="flex ">
                                        <span
                                            class="inline-flex items-center justify-center w-8 h-8 mr-2 text-blue-600 rounded  :text-gray-400  :bg-gray-700 bg-blue-50">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <div class="text-xs">
                                            <p class="font-medium  :text-gray-400">Team members</p>
                                            <p class="text-gray-500  :text-gray-400">Meeting</p>
                                        </div>
                                    </div>
                                    <div class="flex">
                                        <button class="mr-2 text-blue-600  :text-gray-400">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <button class="text-red-600  :text-gray-400">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <div class="flex justify-between p-4 mb-4 bg-gray-100 rounded  :bg-gray-800">
                                    <div class="flex">
                                        ...
                                        <div class="text-xs">
                                            <p class="font-medium  :text-gray-400"> Products</p>
                                            <p class="text-gray-500  :text-gray-400">household</p>
                                        </div>
                                    </div>
                                    <div class="flex">
                                        <button class="mr-2 text-blue-600  :text-gray-400">
                                ...
                                <div class="flex justify-between p-4 mb-4 bg-gray-100 rounded  :bg-gray-800">
                                    <div class="flex">
                                        ...
                                        <div class="text-xs">
                                            <p class="font-medium  :text-gray-400">Time</p>
                                            <p class="text-gray-500  :text-gray-400">3 hours</p>
                                        </div>
                                    </div>
                                    <div class="flex">
                                        <button class="mr-2 text-blue-600  :text-gray-400">
                                ...
                                <div class="flex justify-between p-4 mb-4 bg-gray-100 rounded  :bg-gray-800">
                                    <div class="flex">
                                        ...
                                        <div class="text-xs">
                                            <p class="font-medium  :text-gray-400">Documents</p>
                                            <p class="text-gray-500  :text-gray-400">pdf</p>
                                        </div>
                                    </div>
                                    <div class="flex">
                                        <button class="mr-2 text-blue-600  :text-gray-400">
                        ...
                        <div class="p-4 bg-white rounded-md shadow md:p-6  :bg-gray-900">
                            <h2 class="pb-2 mb-2 text-xl font-bold border-b  :border-gray-700  :text-gray-400">
                                Comments</h2>
                            <div class="flex flex-wrap mb-6">
                                ...
                                <div class="flex-grow px-4">
                                    <a href="#" class="text-black ">
                                        <span class="mr-2 text-lg font-medium  :text-gray-400">Johnsena</span>
                                        <span class="font-normal text-gray-600  :text-gray-400">John@gmail.com</span>
                                    </a>
                                    <div class="flex items-center my-1 text-xs text-gray-600  :text-gray-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <div class="py-4 text-gray-600  :text-gray-400">
                                        Lorem ipsum dor amet
                                    </div>
                                    <div class="flex pt-2 text-sm border-t  :border-gray-700">
                                        <a href="#"
                                            class="flex items-center px-4 py-2 text-black no-underline  :text-gray-400 ">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
