                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        <div class="p-4 bg-white rounded-md shadow md:p-6  :bg-gray-900 ">
                            <div class="flex flex-wrap justify-between mb-6">
                                ...
                                <a href="<?=base_url('/searchproduct')?>" class="px-4 py-2 text-sm text-white capitalize bg-blue-500 rounded ">view
                                    all</a>
                            </div>
                            <div>
                                ...
                                <div class="flex justify-between mb-4">
                                    <div class="flex gap-2">
                                        <img src="https://source.unsplash.com/random?food?sig=<?= $item['id'] ?>"
                                    ...
                                    <div class=""><span class="font-medium text-blue-400">Qty:<?= $item['quantity'] ?></span></div>
                                </div>
                                <?php $counter++;}else{break;}}?>
                            </div>
                        </div>
